<script type="text/javascript">
	...
	$(function()
	{
	    ...
	    $('#formedit').submit(function(){
            $.ajax({
                url:"<?php echo base_url()?>gejala_narkoba/<?php echo $post ?>",
 			    type:"POST",
    ...
    <div class="modal-dialog" >
        <div class="modal-content">
            <div class="modal-header">
				...
				<h4 class="modal-title">Gejala Narkoba Form</h4>
            </div>
            <div class="modal-body">
                <div class="box-body table-responsive">
                        <span id="form-msg">
                        </span>
						<?php echo form_open(base_url()."gejala_narkoba/".$post,'id="formedit"')?>
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-12">
										...
										<div class="form-group">
                                            <label>Diagnosa Narkoba</label>
                                            <select id="narkoba_id" class="form-control" name="narkoba_id" required>
												<option></option>
												<?php foreach($listnarkoba->result() as $value){?>
													<option value="<?php echo $value->id ?>" <?php echo ($value->id == $row['narkoba_id']) ? 'selected':''; ?>><?php echo $value->kode.' - '.$value->keterangan ?></option>
												<?php } ?>
											</select>
                                        </div>
										<div class="form-group">
